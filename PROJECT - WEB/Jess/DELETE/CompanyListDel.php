...
$sql = "SELECT CompanyID, Name, Address, PhoneNo, Email, isBlacklisted, AmountOwed, timesBlacklisted
        FROM Company 
        WHERE deleteFlag = 0
         ";
...
echo "<div class='listboxJ'><br><select name='listbox' id='listbox' onclick='popDelete()'><option >Select Company</option>";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $allText = "$id,$name,$address,$phoneNo,$email,$blacklist,$owed,$times ";
